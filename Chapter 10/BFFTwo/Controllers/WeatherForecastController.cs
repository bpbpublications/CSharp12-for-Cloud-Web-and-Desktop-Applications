...
namespace BFFTwo.Controllers
{
    ...
    public class WeatherForecastController : ControllerBase
    {
        ...
        public async Task< IEnumerable<WeatherForecast>> Get()
        {
            ...
            string url = baseURL + "WeatherForecast?weather=cold";
        ...
        public void Post([FromBody] WeatherForecast weatherForecast)
        {
            ...
            using (var channel = connection.CreateModel())
            {
                ...
                string message = "From BFF Two, Date: " + weatherForecast.Date + ", Temperature in Cº: " + weatherForecast.TemperatureC + " and Summary: " + weatherForecast.Summary;
